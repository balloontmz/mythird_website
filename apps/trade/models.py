...
class OrderInfo(models.Model):
    ...
    trade_no = models.CharField(max_length=30, null=True, blank=True, unique=True, verbose_name='交易号')
    ...
    # 用户信息
    address = models.CharField(max_length=100, default='', verbose_name='收货地址')  # 防止修改个人资料改变该值，不使用外键
