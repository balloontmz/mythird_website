    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_no', models.CharField(blank=True, max_length=30, null=True, unique=True, verbose_name='订单号')),
                ('pay_status', models.CharField(blank=True, choices=[('success', '成功'), ('cancel', '取消'), ('paying', '待支付')], max_length=30, null=True, verbose_name='订单号')),
                ('post_script', models.CharField(blank=True, max_length=200, null=True, verbose_name='订单号')),
